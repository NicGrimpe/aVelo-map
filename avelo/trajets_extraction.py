...
from avelo.trajet import trajet_from_regex
...
def fetch_for_year(avelo: AVelo, year):
    ...
    for month in range(1, 12):
        ...
        trajets = fetch_all_trajets_between_dates(avelo, start_date, end_date)
        yearly_trajets += trajets
    return yearly_trajets

def fetch_all_trajets_between_dates(avelo: AVelo, start_date, end_date):
    ...
    response = avelo.get_page(fetch_url)
